...
<html>
    ...
    <body>
        ...
        <div id="show-evaluation" class="content scaffold-show" role="main">
            ...
            <f:display bean="evaluation" />
            <g:form resource="${this.evaluation}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.evaluation}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
